    ...
    <div class="d-flex">
        ...
        <div class="sidebar">
            <div class="d-flex flex-column h-100">
                <a href="{{ route('secretary.dashboard') }}" class="sidebar-brand d-flex align-items-center">
                ...
                <ul class="nav flex-column flex-grow-1">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('secretary.customers.index') }}" 
                            class="nav-link {{ request()->routeIs('secretary.customers.*') ? 'active' : '' }}">
                            <i class="bi bi-people me-2"></i> Müşteriler
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('secretary.tasks.index') }}" 
                            class="nav-link {{ request()->routeIs('secretary.tasks.*') ? 'active' : '' }}">
                            <i class="bi bi-list-task me-2"></i> Görevler
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('secretary.messages.index') }}" 
                            class="nav-link {{ request()->routeIs('secretary.messages.*') ? 'active' : '' }}">
