...
@section('content')
    <div class="card">
        <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            ...
            <a href="{{ route('secretary.tasks.create') }}" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="badge bg-secondary d-sm-none">
                                        {{ $task->scheduled_date ? $task->scheduled_date->format('d.m.Y H:i') : '-' }}
                                    </span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('secretary.tasks.show', $task) }}"
                                       class="btn btn-sm btn-info"
                                       title="Detay">
                                        <i class="bi bi-eye"></i>
                                        <span class="d-none d-md-inline">Detay</span>
                                    </a>
                                    <a href="{{ route('secretary.tasks.edit', $task) }}"
